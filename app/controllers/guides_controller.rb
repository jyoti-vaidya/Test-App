class GuidesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @guide.save
        format.html { redirect_to @guide, notice: "Employee was successfully created." }
  ...
  def update
    respond_to do |format|
      if @guide.update(guide_params)
        format.html { redirect_to @guide, notice: "Employee was successfully updated." }
  ...
  def destroy
    @guide.destroy
    respond_to do |format|
      format.html { redirect_to guides_url, notice: "Employee was successfully destroyed." }
